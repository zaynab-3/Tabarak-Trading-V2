...
import { Boxes, Building2, FolderTree, Images, Plus, SendToBack, Sparkles, UploadCloud } from '@lucide/vue';
...
<template>
    ...
    <AdminLayout>
        ...
        <section aria-labelledby="catalogue-health">
            ...
            <div class="grid gap-3 sm:grid-cols-2 md:grid-cols-3 2xl:grid-cols-6">
